...
export const IndiePlanPage: React.FC = () => {
  return (
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              <span className="comos-color">Indie Plan</span> ($49/mo)
            </h1>
            <p className="text-xl sm:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">
              Designed for solo founders with 1 app and minimal setup
            </p>
            ...
            <div className="bg-base-100 p-8 rounded-2xl shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-3xl font-bold mb-2">$49 / month</p>
                </div>
                <div>
              ...
              <div className="mt-8">
                ...
                <ul className="space-y-2 text-gray-300">
                  <li>• Log & event collection for 1 app</li>
                  <li>• AI-powered threat detection (failed logins, suspicious IPs, unusual API usage)</li>
                  <li>• Real-time alerts via Slack/Discord/email</li>
                  <li>• Dashboard: traffic-light status + recent incidents</li>
                  <li>• PDF export of incident reports (limited 2-5 per month)</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join solo founders already protecting their apps with COMOS
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="btn comos-bg px-8 py-3 rounded-xl text-white hover:scale-105 transition-transform">
                Get Started
